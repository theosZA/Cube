...
{
  vertices[0] = video::S3DVertex(-5, -5, 0, -1, -1, -1, color, 0, 0);
  vertices[1] = video::S3DVertex(5, -5, 0, 1, -1, -1, color, 1, 0);
  vertices[2] = video::S3DVertex(5, 5, 0, 1, 1, -1, color, 1, 1);
  vertices[3] = video::S3DVertex(-5, 5, 0, -1, 1, -1, color, 0, 1);
